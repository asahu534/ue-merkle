...
/**
 * Transformer: Merkle section breaks + Section Metadata.
 * Section boundaries and styles come from tools/importer/page-templates.json
 * (template "home"): rc2 (Hero, dark), rc3 (Latest and greatest, no style),
 * rc4 (Experience economy, dark).
 *
 * Inserts <hr> in beforeTransform (while every section element still exists,
 * before block parsers replace them) using a temporary marker attribute, then
 * anchors Section Metadata blocks to that marker in afterTransform. See
